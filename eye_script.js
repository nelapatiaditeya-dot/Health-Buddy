const selectImage = document.querySelector('.select-image');
    ...
    const URL = "https://teachablemachine.withgoogle.com/models/WoSyG_WCQ/"; // Replace with the URL where the model and metadata files are located
    ...
    async function predict(image) {
      ...
      const messages = {
        ...
        retina_disease: "Retina damage detected"
      };
